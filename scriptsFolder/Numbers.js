...
/* проблемний вираз, оскільки дробові числа не точні 
let i = 0;
while (i != 10) {
  i += 0.2;
}
Значення i ніколи точно не дорівнює 10 через накопичення похибок при додаванні 0.2. 
Замість того, щоб отримати рівно 10, ти отримаєш щось типу 10.00000000000001 або 9.99999999999998.
*/
