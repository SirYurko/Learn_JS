...
//---------------------------------
// 01.02.2025 practice Map()

//У тебе є масив чисел. Використовуючи map(), створи новий масив, у якому:
// Якщо число парне — заміни його на "even".
// Якщо число непарне — заміни його на "odd".


const numbers = [3, 10, 7, 8, 15, 22];
